...
<div class="app-menu navbar-menu">
    ...
    <div class="navbar-brand-box">
        ...
        <a class="logo logo-light">
            <span class="logo-sm">
                <img style="border-radius: 20px" src="{{ URL::asset('assets/images/evo.png') }}"
                    alt="" height="22">
            </span>
            <span class="logo-lg">
                <img style="border-radius: 20px" src="{{ URL::asset('assets/images/evo.png') }}"
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarPenawaran">
                        <ul class="nav nav-sm flex-column">
                            <!-- List Penawaran -->
                            <li class="nav-item">
                                <a href="{{ url('new/list_quotation') }}"
                                    class="nav-link menu-link {{ request()->is('list-penawaran') ? 'active' : '' }}">
                            ...
                            <li class="nav-item">
                                <a href="#"
                                    class="nav-link menu-link {{ request()->is('create-penawaran') ? 'active' : '' }} disabled">
                            ...
                            <li class="nav-item">
                                <a href="{{ url('new/freight_quotation') }}"
                                    class="nav-link menu-link {{ request()->is('freight-quotation') ? 'active' : '' }}">
                                    <span>Freight Quotation</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ url('new/freight_expense') }}"
                                    class="nav-link menu-link {{ request()->is('freight-expense') ? 'active' : '' }}">
                                    <span>Freight Expense</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ url('new/freight_comparison') }}"
                                    class="nav-link menu-link {{ request()->is('freight-comparison') ? 'active' : '' }}">
                                    <span>Freight Comparison</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ url('forwarding') }}"
                                    class="nav-link menu-link {{ request()->is('forwarding') ? 'active' : '' }}">
                                    <span>Forwarding</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ url('new/expedition') }}"
                                    class="nav-link menu-link {{ request()->is('ekspedisi') ? 'active' : '' }}">
                                    <span>Expedition</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ url('new/rawMaterial') }}"
                                    class="nav-link menu-link {{ request()->is('bahan-baku') ? 'active' : '' }}">
                                    <span>Raw Material</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ url('new/packaging') }}"
                                    class="nav-link menu-link {{ request()->is('packaging') ? 'active' : '' }}">
                                    <span>Packaging</span>
                                </a>
                            </li>
                            </ul>
                            ...
                            <li class="nav-item">
                                <a href="#"
                                    class="nav-link menu-link {{ request()->is('approval-logistik') ? 'active' : '' }} disabled">
                                    <span>Approval Penawaran</span>
                                </a>
                            </li>
                            <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="{{ url('new/approval_freight') }}"
                                    class="nav-link menu-link {{ request()->is('approval-freight') ? 'active' : '' }}">
                                    <span>Freight</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ url('new/approval_expedition_user') }}"
                                    class="nav-link menu-link {{ request()->is('approval-expedition') ? 'active' : '' }}">
                                    <span>Expedition</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ url('new/approval_raw_material_user') }}"
                                    class="nav-link menu-link {{ request()->is('approval-bahan-baku') ? 'active' : '' }}">
                                    <span>Raw Material</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ url('new/approval_packaging_user') }}"
                                    class="nav-link menu-link {{ request()->is('approval-packaging') ? 'active' : '' }}">
                                    <span>Packaging</span>
                                </a>
                            </li>
                            </ul>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarApproval">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="{{ url('new/approval_freight_admin') }}"
                                    class="nav-link menu-link {{ request()->is('approval-bahan-baku') ? 'active' : '' }}">
                                    <span>Freight</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ url('new/approval_expedition_admin') }}"
                                    class="nav-link menu-link {{ request()->is('approval-bahan-baku') ? 'active' : '' }}">
                                    <span>Expedition</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ url('new/approval_raw_material_admin') }}"
                                    class="nav-link menu-link {{ request()->is('approval-logistik') ? 'active' : '' }}">
                                    <span>Raw Material</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ url('new/approval_packaging_admin') }}"
                                    class="nav-link menu-link {{ request()->is('approval-logistik') ? 'active' : '' }}">
                                    <span>Packaging</span>
                                </a>
                            </li>
...
{{-- 
                <li class="nav-item ">
                    <a href="{{ url('new/confirm_quotation') }}"
                        class="nav-link menu-link {{ request()->is('konfirmasi') ? 'active' : '' }}">
                        <i class="ri-home-line"></i><span>Konfirmasi</span>
                    </a>
                </li> --}}
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarDO">
                        <ul class="nav nav-sm flex-column">
                            <!-- List Penawaran -->
                            <li class="nav-item ">
                                <a href="{{ url('new/display-order') }}"
                                    class="nav-link menu-link {{ request()->is('purchase-order') ? 'active' : '' }}">
                                    <span>Display Order</span>
                                </a>
                            </li>
                            <li class="nav-item ">
                                <a href="{{ url('new/purchase-order') }}"
                                    class="nav-link menu-link {{ request()->is('purchase-order') ? 'active' : '' }}">
                                    <span>Transaksi</span>
                                </a>
                            </li>
...
{{--                
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link  " href="#Invoice" data-bs-toggle="collapse" role="button"
                        ...
                        <i class="ri-profile-line"></i> <span>Invoice</span>
                    </a>
                    <div class="collapse menu-dropdown" id="Invoice">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item ">
                                <a href="{{ url('master-jenis-bantuan') }}"
                                    class="nav-link menu-link {{ request()->is('master-jenis-bantuan') ? 'active' : '' }}">
                                    <span>Master Jenis Bantuan</span>
                                </a>
                            </li>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="Profil">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item ">
                                <a href="{{ url('new/list_perusahaan') }}"
                                    class="nav-link menu-link {{ request()->is('master-jenis-bantuan') ? 'active' : '' }}">
                                    <span>List Perusahaan</span>
                                </a>
                            </li>
                            <li class="nav-item ">
                                <a href="{{ url('new/profil_perusahaan') }}"
                                    class="nav-link menu-link {{ request()->is('master-jenis-bantuan') ? 'active' : '' }}">
                                    <span>Profil Perusahaan</span>
                                </a>
                            </li>
                            <li class="nav-item ">
                                <a href="{{ url('new/jenis_angkutan') }}"
                                    class="nav-link menu-link {{ request()->is('master-jenis-bantuan') ? 'active' : '' }}">
