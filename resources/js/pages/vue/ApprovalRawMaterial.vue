<template>
    <div class="quotation-card">
        <div class="quotation-header mb-3">
            <h5 class="text-center">Approval Raw Material | List View</h5>
            <hr />
        </div>
        ...
        <div class="filter-bar justify-content-end d-flex mb-3">
            <div class="buttons">
                ...
                <a
                    href="tambah_approval_raw_material_admin"
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    >
                        ...
                        <td>
                            <a
                                :href="`detail_approval_raw_material_admin?NoPenawaran=${data.NoPenawaran}`"
        ...
        <!-- Pagination -->
        <div class="pagination d-flex justify-content-end mt-3 text-center">
