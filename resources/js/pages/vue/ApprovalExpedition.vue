<template>
    <div class="quotation-card">
        <div class="quotation-header mb-3">
            <h5>Approval Expedition | List View</h5>
            <hr />
        </div>
        ...
        <div class="filter-bar justify-content-end d-flex mb-3">
            <div class="buttons">
                <button class="btn btn-primary ms-2">Filters</button>
                <a
                    class="btn btn-success ms-2"
                    href="tambah_approval_expedition"
                    >Tambah</a
                >
            </div>
        </div>
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    >
                        ...
                        <td>
                            <a
                                :href="`detail_approval_expedition_admin?NoPenawaran=${data.NoPenawaran}`"
