<template>
    <div class="quotation-card">
        <div class="quotation-header mb-3">
            <h5 class="text-center">Quotation Raw Material | List View</h5>
            <hr />
        </div>
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    >
                        ...
                        <td>
                            <a
                                :href="`detail_approval_raw_material_user?NoPenawaran=${data.NoPenawaran.replace(
                                    '/',
                                    '@'
                                )}`"
